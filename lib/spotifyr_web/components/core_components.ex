defmodule SpotifyrWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(SpotifyrWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(SpotifyrWeb.Gettext, "errors", msg, opts)
    # end
